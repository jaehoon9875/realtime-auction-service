...
**README.md** (사람용)
- 가독성 우선: 테이블, 링크, 코드블록 적극 활용
- 해당 경로 개요 + docs/ 주요 문서로의 네비게이션 역할
- 핵심 내용은 직접 작성하지 않고 docs/ 링크로 연결

**CLAUDE.md** (AI용)
- 정보 밀도 우선: 마크다운 장식(테이블, 하이퍼링크) 최소화
- AI가 문맥 파악에 필요한 핵심 정보만 포함, 불필요한 내용 제거
- 사람용 가이드(사용법, 명령어 예시)는 README.md로 이동

**docs/ 원칙**
- 설계 결정, API 명세, 스키마 등 핵심 문서는 docs/에서 중앙 관리
- 각 디렉토리의 README.md는 관련 docs/ 문서로 링크
