...
- [x] Gradle 멀티모듈 세팅 완료 (Spring Boot 4.0.6 / Java 21, user-service, api-gateway, auction-service 등록)
- [x] docker-compose — `infra/docker-compose.yml`
- [x] API Gateway 라우팅 기본 설정 — Spring Cloud Gateway 5.x (`spring-cloud-starter-gateway-server-webflux`)
- [x] auction-service CRUD·Outbox·Debezium 구현 완료
- [x] Gateway 내부 시크릿 헤더·인증/인가 역할 분리 완료
