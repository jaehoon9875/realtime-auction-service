...
/**
 * bid-events 토픽에서 입찰 이벤트를 소비하고 알림 이벤트를 발행하는 Kafka Streams 토폴로지.
 * 
 */
@Component
...
public class BidStreamsTopology {
        ...
        public void buildTopology() {
                ...
                builder.stream(TOPIC_BID_EVENTS, Consumed.with(Serdes.String(), bidEventSerde))
                                .filter((key, event) -> event != null
                                                && EVENT_BID_REJECTED.equals(event.getEventType()))
